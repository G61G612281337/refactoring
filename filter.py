...
def create_namespace():
    images_splits = argparse.ArgumentParser()
    images_splits.add_argument('-i', '--image', default=None, metavar='',
                            help='set image to transform into a mosaic in grayscale')
    images_splits.add_argument('-r', '--result', default='res.jpg', metavar='',
                            help='set name with which the result will be saved')
    return images_splits.parse_args(sys.argv[1:])
